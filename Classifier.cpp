...
double Classifier::classifyKNN(const std::vector<Object> &trainSet, const std::vector<Object> &testSet) {

    return 0;
}

double Classifier::classifyKNM(const std::vector<Object> &trainSet, const std::vector<Object> &testSet) {
